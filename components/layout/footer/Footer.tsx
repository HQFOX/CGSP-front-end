        ...
        <StyledFooter>
            <Grid container spacing={2}>
                <StyledItem item xs={12} md={4}>
                    ...
                    <Typography variant="subtitle1">Instituto da Habitação e da Reabilitação Urbana - IHRU</Typography>
                ...
                <StyledItem item xs={12} md={4} textAlign="right">
                    ...
                    <Typography variant="subtitle1">{t("address")}: Évora B. Malagueira R. do Sarrabulho 4 </Typography>
